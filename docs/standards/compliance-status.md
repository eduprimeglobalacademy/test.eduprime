...
- ~~No server-state library~~ **Superseded — TanStack Query adopted in a later pass.** See `state-management-compliance-status.md` for the dedicated gap analysis against `react-tanstack-query-state-management-standards.md`.
